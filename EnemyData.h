...
static EnemyDataNode enemyArray[] = {
	{{0, 0}, 0, 10, 100, 8, 0.5f}, 
	{{16, 0}, 20, 11, 150, 8, 0.5f},
	{ { 32, 0 }, 30, 11, 200, 10, 1.0f },
	{ { 48, 0 }, 10, 12, 200, 10, 1.5f },
	{ { 64, 0 }, 40, 13, 100, 12, 1.0f},
	{ { 0, 24 }, 40, 14,150, 12, 0.8f },
	{ { 16, 24 }, 50, 15,300, 12, 0.8f },
	{ { 32, 24 }, 10, 16, 500, 8, 0.6f },
	{ { 48, 24 }, 0, 20, 500, 10, 0.8f },
	{ { 64, 24 }, 50, 22, 100, 15, 1.0f }
};
