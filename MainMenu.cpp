...
bool MainMenu::init() {
    ...
    objectsHandler->loadTextIntoHolder("Settings", 27, { 352 - (objectsHandler->calculateTextWidth("Settings", 27)) / 2, 124 });
    objectsHandler->loadTextIntoHolder("Gallery", 27, { 352 - (objectsHandler->calculateTextWidth("Gallery", 27)) / 2, 169 });
